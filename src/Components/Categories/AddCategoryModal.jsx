...
const AddCategoryModal = ({ isOpen, onClose, onSave }) => {
    ...
    const handleSave = () => {
        if (!name.trim()) return; // Prevent saving empty name
    ...
    // Available color options for the dot (matching common Tailwind/UI colors)
    const colorOptions = [
        { value: '#22c55e', label: 'Green' }, // Income default
        { value: '#ef4444', label: 'Red' },   // Expense default
    ...
    // Determine button/default color based on type selection for visual consistency
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full p-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 appearance-none bg-white"
                        >
